...
Q. Weakest soldier:
  ...
  - A row i is weaker than a row j if one of the following is true:
    a. the number of soldiers in row i is less than the number of soldiers in row j.
    b. both rows have the same number of soldiers and i<j.
